                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                                    ...
                                    <div class="overview-item overview-item--c1">
                                        <div class="overview__inner">
                                            <div class="overview-box clearfix">
                                                ...
                                                <div class="text">
                                                    <?php $cat = App\Category::select('select * from category')->count(); ?>
                                                    <h2>{{ $cat }}</h2>
                                    ...
                                    <div class="overview-item overview-item--c3">
                                        <div class="overview__inner">
                                            <div class="overview-box clearfix">
                                                ...
                                                <div class="text">
                                                    <?php $popproduct = App\Product::select('select * from product')
                                                        ->where('status', '1')
                                                        ->count(); ?>
                                                    <h2>{{ $popproduct }}</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <h2 class="title-1 m-b-25">Total Post</h2>
                                    <div class="table-responsive table--no-card m-b-40">
                                        <table class="table table-borderless table-striped table-earning">
                                            ...
                                            <tbody>
                                                <?php $products = App\Product::get(); ?>
                                                @foreach ($products as $pop)
                                                    <tr>
                                                        <td>{{ $pop->created_at }}</td>
                                                        <td>{{ $pop->title }}</td>
                                                        <td class="text-right"> <img
                                                                src="{{ URL::asset('item_img') }}/{{ $pop->item_img }}"
                                                                alt="img" width="80px" height="80px" /></td>
